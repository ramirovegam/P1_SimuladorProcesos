...
public class OptimoPageReplacement {
        ...
        for (int i = 0; i < references.size(); i++) {
            ...
            if (contains(frames, page)) {
                ...
                if (empty >= 0) {
                    ...
                    // Elegir víctima según uso futuro
                    int victim = findVictim(frames, references, i + 1);
                    frames[victim] = page;
                    changedIndex = victim;
                }
            }
    ...
    private static int findVictim(String[] frames, List<String> refs, int startIndex) {
        int farthest = -1;
        int victimIndex = -1;
        ...
        for (int i = 0; i < frames.length; i++) {
            ...
            for (int j = startIndex; j < refs.size(); j++) {
